...
class SaveRecordActionTest : BaseTest() {
    ...
    companion object {
        ...
        private const val RECORD_DATA = "Lorem ipsum dolor sit amet, volutpat velit adipiscing ligula lorem tortor mauris, vel ipsum " +
                "porttitor vivamus nec, nascetur augue. Integer ut et, consequat ac urna, pede elementum ut vitae orci. Sed lorem sodales nam " +
                "viverra semper, curabitur suscipit ut suscipit proin lectus facilisis, donec sapien facilisis volutpat, aliquam adipiscing " +
                "consectetuer mauris neque quam, laoreet in. Nunc augue quis per vestibulum, neque curabitur egestas hymenaeos, diam pede. " +
                "Dolor lacus elit ultricies pellentesque sed. Ante amet ipsum duis sit est integer."
